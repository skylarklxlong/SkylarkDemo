...
/**
 * Created by：LiXueLong 李雪龙 on 2017/11/13 14:16
 * <p>
...
public class HeartView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public PointInfo getHeartPoint(float angle) {
        ...
        return new PointInfo(offsetX + (int) x, offsetY + (int) y);
    }
    ...
    private Bloom getBloom(float angle) {
        ...
        PointInfo p = getHeartPoint(angle);
