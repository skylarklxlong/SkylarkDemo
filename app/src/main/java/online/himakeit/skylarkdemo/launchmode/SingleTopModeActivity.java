 ...
 * @des:
 */
public class SingleTopModeActivity extends AppCompatActivity {

    private static final String TAG = "SingleTopMode";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_launch_mode).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SingleTopModeActivity.this, StandardModeActivity.class));
            }
        });
        findViewById(R.id.btn_launch_mode_next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SingleTopModeActivity.this, SingleTaskModeActivity.class));
            }
        });
    }
