...
public class SingleTaskModeActivity extends AppCompatActivity {
    ...
    private static final String TAG = "SingleTaskMode";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_launch_mode).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SingleTaskModeActivity.this, SingleTopModeActivity.class));
            }
        });
        findViewById(R.id.btn_launch_mode_next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SingleTaskModeActivity.this, SingleInstanceModeActivity.class));
            }
        });
    }
