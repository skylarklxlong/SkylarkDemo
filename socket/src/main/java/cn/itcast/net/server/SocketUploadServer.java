...
public class SocketUploadServer {
    ...
    public static void main(String[] args) {
        try {
            SocketUploadServer socketUploadServer = new SocketUploadServer(7878);
    ...
    public SocketUploadServer(int port) {
        this.port = port;
    ...
    private final class SocketTask implements Runnable {
        ...
        public void run() {
            try {
                ...
                System.out.println("client say "+head);
                if (head != null) {
                    //下面从协议数据中提取各项参数值
                    ...
                    System.out.println("server创建生产资源id：" + id);
                    FileLog log = null;
